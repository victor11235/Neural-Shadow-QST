...
class TransformerWF_phase(NeuralQuantumState):
    def __init__(self,
                 num_sites,
                 num_layers,
                 internal_dimension,
        ...
        Args:
            ...
            phase_mode (int): how to deal with the phase.
                ...
                2: concatenate transformer outputs over sites, project with a
                    big learned vector
        """
        super(TransformerWF_phase, self).__init__()
    ...
    def forward(self,
        ...
        logmoduli = torch.zeros_like(phases)
    ...
    def sample(self, num_samples):
        ...
        We do not need to implement this part since we collect samples from the amplitude norm wavefunction
